...
import { RecievedDialogComponent } from 'app/recieved-dialog/recieved-dialog.component';
...
export class RecievedComponent implements OnInit {
  ...
  loading = false;
    ...
    ngOnInit() {
      let resp1= this.http.get("https://api.team4loans.in/api/loan_add/file")
  ...
  console.log(this.app_rvd);
    ...
    openModal(bar_code) {
        ...
        const modalDialog = this.matDialog.open(RecievedDialogComponent, dialogConfig);
      } 
      refresh() {
