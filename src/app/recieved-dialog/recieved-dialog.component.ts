...
@Component({
  selector: 'app-recieved-dialog',
  templateUrl: './recieved-dialog.component.html',
  styleUrls: ['./recieved-dialog.component.scss']
})
export class RecievedDialogComponent implements OnInit {
  ...
  constructor(private http: HttpClient,private router:Router,route :ActivatedRoute,public dialogRef: MatDialogRef<RecievedDialogComponent>,@Inject(MAT_DIALOG_DATA) public data) {
    this.bar_code=data;
   }
