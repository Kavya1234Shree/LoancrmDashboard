...
export class NotyDialogComponent implements OnInit {
  ...
  constructor(private http: HttpClient,private router:Router,route :ActivatedRoute,private userService: UserService,private authenticationService: AuthenticationService,public dialogRef: MatDialogRef<NotyDialogComponent>,@Inject(MAT_DIALOG_DATA) public data) {
    this.bar_code=data;
...
//   let resp = this.http.get<any>("https://api.team4loans.in/api/loan_add/final-update?bar_code="+this.bar_code);
//   resp.subscribe((data:any)=>{
