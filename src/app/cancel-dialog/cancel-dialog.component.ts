...
export class CancelDialogComponent implements OnInit {
  ...
  constructor(private http: HttpClient,private router:Router,route :ActivatedRoute,public dialogRef: MatDialogRef<CancelDialogComponent>,@Inject(MAT_DIALOG_DATA) public data) {
    this.bar_code=data;
   }
