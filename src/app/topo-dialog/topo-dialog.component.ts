...
@Component({
  selector: 'app-topo-dialog',
  templateUrl: './topo-dialog.component.html',
  styleUrls: ['./topo-dialog.component.scss']
})
export class TopoDialogComponent implements OnInit {
  ...
  constructor(private http: HttpClient,private router:Router,route :ActivatedRoute,public dialogRef: MatDialogRef<TopoDialogComponent>,@Inject(MAT_DIALOG_DATA) public data) {
    this.bar_code=data;
    console.log('baarcode',this.bar_code)
   }
