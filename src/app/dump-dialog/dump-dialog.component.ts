...
@Component({
  selector: 'app-dump-dialog',
  templateUrl: './dump-dialog.component.html',
  styleUrls: ['./dump-dialog.component.scss']
})
export class DumpDialogComponent implements OnInit {
 ...
 constructor(private http: HttpClient,private router:Router,route :ActivatedRoute,public dialogRef: MatDialogRef<DumpDialogComponent>,@Inject(MAT_DIALOG_DATA) public data) {
   this.bar_code=data;
  }
