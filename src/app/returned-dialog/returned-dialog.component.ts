...
@Component({
  selector: 'app-returned-dialog',
  templateUrl: './returned-dialog.component.html',
  styleUrls: ['./returned-dialog.component.scss']
})
export class ReturnedDialogComponent implements OnInit {
  ...
  constructor(private http: HttpClient,private router:Router,route :ActivatedRoute,public dialogRef: MatDialogRef<ReturnedDialogComponent>,@Inject(MAT_DIALOG_DATA) public data) {
    this.bar_code=data;
   }
