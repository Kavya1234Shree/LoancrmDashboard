...
@Component({
  selector: 'app-totaldata-dialog',
  templateUrl: './totaldata-dialog.component.html',
  styleUrls: ['./totaldata-dialog.component.scss']
})
export class TotaldataDialogComponent implements OnInit {
  ...
  constructor(private http: HttpClient,private router:Router,route :ActivatedRoute,public dialogRef: MatDialogRef<TotaldataDialogComponent>,@Inject(MAT_DIALOG_DATA) public data) {
    this.bar_code=data;
   }
...
accountsssss=[
 ...
 ngOnInit() {
  ...
  let resp1 = this.http.get<any>("https://api.team4loans.in/api/loan_add/id?bar_code="+this.bar_code);
